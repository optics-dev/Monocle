...
object Field4 extends Field4Functions {
  ...
  def fromIso[S, A, B](iso: Iso[S, A])(implicit ev: Field4[A, B]): Field4[S, B] = Field4(
  ...
  implicit def tuple5Field4[A1, A2, A3, A4, A5]: Field4[(A1, A2, A3, A4, A5), A4] = Field4(
    Lens((_: (A1, A2, A3, A4, A5))._4)(a => t => t.copy(_4 = a))
  )

  implicit def tuple6Field4[A1, A2, A3, A4, A5, A6]: Field4[(A1, A2, A3, A4, A5, A6), A4] = Field4(
