...
class FieldsExample extends MonocleSuite {
  test("_1 creates a Lens from a 2-6 tuple to its first element") {
    ...
    assertEquals((("Hello", 3, true) applyLens first replace "World"), (("World", 3, true)))
  ...
  test("_2 creates a Lens from a 2-6 tuple to its second element") {
    ...
    assertEquals((("Hello", 3, true, 5.6, 7L, 'c') applyLens second replace 4), (("Hello", 4, true, 5.6, 7L, 'c')))
  }
  ...
  test("_6 creates a Lens from a 6-tuple to its sixth element") {
    ...
    assertEquals((("Hello", 3, true, 5.6, 7L, 'c') applyLens sixth replace 'a'), (("Hello", 3, true, 5.6, 7L, 'a')))
  }
}
