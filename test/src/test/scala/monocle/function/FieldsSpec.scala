...
class FieldsSpec extends Spec {
  ...
  checkAll("_1 3-tuple", LensLaws(_1[(Int, Char, Boolean), Int]))
  checkAll("_1 4-tuple", LensLaws(_1[(Int, Char, Boolean, String), Int]))
  checkAll("_1 5-tuple", LensLaws(_1[(Int, Char, Boolean, String, Long), Int]))
  checkAll("_1 6-tuple", LensLaws(_1[(Int, Char, Boolean, String, Long, Float), Int]))

  checkAll("_2 2-tuple", LensLaws(_2[(Int, Char), Char]))
  checkAll("_2 3-tuple", LensLaws(_2[(Int, Char, Boolean), Char]))
  checkAll("_2 4-tuple", LensLaws(_2[(Int, Char, Boolean, String), Char]))
  checkAll("_2 5-tuple", LensLaws(_2[(Int, Char, Boolean, String, Long), Char]))
  ...
  checkAll("_3 4-tuple", LensLaws(_3[(Int, Char, Boolean, String), Boolean]))
  checkAll("_3 5-tuple", LensLaws(_3[(Int, Char, Boolean, String, Long), Boolean]))
  ...
  checkAll("_4 5-tuple", LensLaws(_4[(Int, Char, Boolean, String, Long), String]))
