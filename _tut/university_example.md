...
res0: monocle.example.UniversityExample.University = University(oxford,Map(Computer Science -> Department(45,List(Lecturer(john,doe,10), Lecturer(robert,johnson,16)))))
```
...
res1: monocle.example.UniversityExample.University = University(oxford,Map(Computer Science -> Department(45,List(Lecturer(john,doe,10), Lecturer(robert,johnson,16))), History -> Department(30,List(Lecturer(arnold,stones,20))), Physics -> Department(36,List(Lecturer(daniel,jones,12), Lecturer(roger,smith,14)))))
```
...
res3: monocle.example.UniversityExample.University = University(oxford,Map(Computer Science -> Department(45,List(Lecturer(john,doe,12), Lecturer(robert,johnson,18))), History -> Department(30,List(Lecturer(arnold,stones,22)))))
```
...
upperCasedFirstName: monocle.example.UniversityExample.University = University(oxford,Map(Computer Science -> Department(45,List(Lecturer(John,doe,10), Lecturer(Robert,johnson,16))), History -> Department(30,List(Lecturer(Arnold,stones,20)))))

scala> (allLecturers composeLens lastName composeOptional headOption).modify(_.toUpper)(upperCasedFirstName)
res4: monocle.example.UniversityExample.University = University(oxford,Map(Computer Science -> Department(45,List(Lecturer(John,Doe,10), Lecturer(Robert,Johnson,16))), History -> Department(30,List(Lecturer(Arnold,Stones,20)))))
```
...
res5: monocle.example.UniversityExample.University = University(oxford,Map(Computer Science -> Department(45,List(Lecturer(John,Doe,10), Lecturer(Robert,Johnson,16))), History -> Department(30,List(Lecturer(Arnold,Stones,20)))))
```
