...
lazy val scala3Versions = Seq("3.1.2")
...
lazy val refinedDep        = Def.setting("eu.timepit" %%% "refined" % "0.9.29")
lazy val refinedScalacheck = Def.setting("eu.timepit" %%% "refined-scalacheck" % "0.9.29" % "test")
