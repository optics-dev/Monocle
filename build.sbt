...
lazy val refinedDep        = Def.setting("eu.timepit" %%% "refined" % "0.9.23")
lazy val refinedScalacheck = Def.setting("eu.timepit" %%% "refined-scalacheck" % "0.9.23" % "test")
...
lazy val munitDiscipline = Def.setting("org.typelevel" %% "discipline-munit" % "1.0.7" % Test)
