...
lazy val shapeless  = Def.setting("com.chuusai"     %%% "shapeless"   % "2.2.5")
lazy val refinedDep = Def.setting("eu.timepit"      %%% "refined"     % "0.3.2")
lazy val refinedScalaCheckDep = Def.setting("eu.timepit"  %%% "refined-scalacheck" % "0.3.2" % "test")
