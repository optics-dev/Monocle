...
lazy val refinedDep         = Def.setting("eu.timepit"      %%% "refined"              % "0.9.7")
lazy val refinedScalacheck  = Def.setting("eu.timepit"      %%% "refined-scalacheck"   % "0.9.7" % "test")

lazy val discipline         = Def.setting("org.typelevel"   %%% "discipline-scalatest" % "0.12.0-M2")
...
lazy val kindProjector  = "org.typelevel"  % "kind-projector" % "0.10.2" cross CrossVersion.binary
